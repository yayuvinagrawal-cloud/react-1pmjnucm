...
const ALL_KITS = [
  { name: "Cait", roles: ["Frontline"], tier: "S" },
  {
    ...
    tier: "S",
    description: "Lassy is the lasso kit. She buys a lasso from the shop, throws it at enemies from range, pulls the first target hit toward her, and applies Grounded to shut down many dash or teleport escapes.",
    tips: "Use Lassy to punish bridge players, stop movement kits, or pull one enemy into a focused team fight. The lasso is setup utility, not raw damage.",
  },
  ...
  { name: "Sheila", roles: ["Frontline"], tier: "B" },
  {
    ...
    roles: ["Frontline"],
    tier: "A",
    description: "Nyx is a fighter built around Midnight, not invisibility. Dealing damage charges her ability; activating Midnight gives ramping damage, armor penetration, and a small speed boost while lowering her armor.",
    tips: "Enter Midnight when you can keep hitting. Back out if the fight stalls, because the armor reduction makes wasted Midnight windows punishable.",
  },
  { name: "Freiya", roles: ["Frontline"], tier: "B" },
  { name: "Lucia", roles: ["Economy", "Frontline"], tier: "A" },
  {
    name: "Aery",
    roles: ["Frontline"],
    tier: "S",
    description: "Aery is a scaling fighter, not a movement kit. Kills collect spirit butterflies that increase damage for the match, but Aery has reduced base health and loses part of her stack count after dying once she has enough butterflies.",
    tips: "Play for clean kills and stay alive after stacking. Aery gets scary from damage scaling, not from mobility, invulnerability, or fall-damage tech.",
  },
  ...
  { name: "Melody", roles: ["Support"], tier: "S" },
  {
    ...
    roles: ["Frontline"],
    tier: "A",
    description: "Hannah is an execute fighter. She can leap to and instantly kill nearby enemies below the execute health threshold, while her base health is reduced.",
    tips: "Let teammates lower the target first, then execute to finish the fight. Do not describe Hannah as a lasso kit; that is Lassy's job.",
  },
  ...
  },
  {
    ...
    tips: "Chain a soul after a pick to reset, escape, or re-enter. The soul only appears after a kill or assist, so plan around confirmed picks.",
  },
  {
    name: "Ares",
    roles: ["Ranged"],
    ...
    kitClass: "Ranged",
    kitRoles: ["SJ", "MJ"],
    description: "Ares is a ranged kit built around shop-bought Spears. Spears deal burst damage with armor penetration, knock back enemies in a small impact radius, apply Zapped, return on a spear final hit, and have an inventory cap.",
    tips: "Use spear AOE and knockback to control bridges or sky fights before your melee commit. Save enough iron so you are not stuck without spears.",
  },
  {
    name: "Styx",
  ...
  },
  {
    ...
    description: "Kaida is a fighter whose swords are replaced by Summoner Claws. The claws have bigger range and can hit multiple enemies, while her summon grows a rune under her feet and calls a dragon head for AOE damage. Successful summons level up the dragon and improve the claw/summon strength.",
    tips: "Use Kaida to punish grouped defenders with AOE. Her current pressure is grouped damage around the summon, not wall hits.",
  },
  {
    name: "Lian",
    roles: ["Frontline", "Bed Breaker"],
  ...
  },
  {
    ...
    kitRoles: ["Bypass"],
    description: "Crypt builds an undead army from gravestones created by enemy deaths. His staff claims souls to summon skeletons that inherit the defeated enemy's strongest melee weapon and helmet, and recent updates added skeleton recall, target selection, and skeleton archers.",
    tips: "Collect early gravestones, then direct or recall skeletons so they pressure the right fight. Skeletons are best as extra pressure beside your team, not a replacement for clean entries.",
  },
  {
    name: "Sophia",
    ...
    kitClass: "Ranged",
    kitRoles: ["Control"],
    description: "Sophia uses a Frost Staff to slow and freeze enemies. The staff swaps between frost mist and ice spear style attacks, and its staff damage has armor penetration.",
