...
function Footer() { return <footer className="footer"><span className="brand" style={{ pointerEvents: "none" }}><span className="brandDot" /> BW META</span><p>Community guide for Roblox BedWars 5v5. Not affiliated with Roblox or the BedWars developers.</p><p>Season 16 · Updated regularly</p></footer>; }
